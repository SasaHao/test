...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="htmlHead">
        <head>
            <title>
                <xsl:value-of select="testng:getVariableSafe($testNgXslt.reportTitle, 'LeTV-AutoTest-Results')"/>
            </title>
        ...
        <xsl:result-document href="{testng:absolutePath('overview.html')}" format="xhtml">
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
                 ...
                 <!--     <h5>click to view details: <a>http://10.110.60.32:8080/job/ad_show_test/ws/test-output/LeEcoAutoTset-ads-Results.html</a></h5>
                  -->  
    ...
    <xsl:template name="powered-by">
        <div style="margin-top: 15px; color: gray; text-align: center; font-size: 9px;">
            Generated with
            <a href="http://www.leshiren.cn/portal/letv" style="color: #8888aa;" target="_blank">
                LeTV Test Team
            </a>
        </div>
    </xsl:template>
